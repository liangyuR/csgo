...
from core.model_registry import is_cs2_model as is_cs2_model_id
...
class TriggerPage(BasePage):
    ...
    def setConfig(self, config):
        self._config = config
        self._loadFromConfig()
        is_current_cs2_model = is_cs2_model_id(getattr(config, 'model_id', ''))
        self.fireTargetCard.setVisible(not is_current_cs2_model)
        self.areaGroup.setVisible(not is_current_cs2_model)
