...
class OtherPage(BasePage):
    ...
    def _initWidgets(self):
        ...
        self.discordBtn.setIcon(QIcon(os.path.join(self.base_path, "assets", "discord.svg")))

        self.githubBtn = PushButton(t("github"))
        self.githubBtn.setIcon(FluentIcon.GITHUB.icon())

        self.donateBtn = PushButton(t("donate"))
        self.donateBtn.setIcon(FluentIcon.HEART.icon())
